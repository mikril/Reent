...
class DataSetTests(TestCase):
    def test_dataSet_type(self):
        self.assertEqual(type(DataSet('vacancies.csv',["Дата публикации","15.12.2022"],"Думайте","","ядерка")).__name__,'DataSet')
    def test_dataSet_file_name(self):
        self.assertEqual(DataSet('vacancies.csv',["Дата публикации","15.12.2022"],"Думайте","","ядерка").file_name, 'vacancies.csv')
    def test_dataSet_filterElements1(self):
        self.assertEqual(DataSet('vacancies.csv',["Дата публикации","15.12.2022"],"Думайте","","ядерка").filterElements[0],'Дата публикации')
    def test_dataSet_filterElements2(self):
        self.assertEqual(DataSet('vacancies.csv',["Дата публикации","15.12.2022"],"Думайте","","ядерка").filterElements[1],'15.12.2022')
    def test_dataSet_sortElements(self):
        self.assertEqual(DataSet('vacancies.csv',["Дата публикации","15.12.2022"],"Думайте","","ядерка").sortElements,'Думайте' )
    def test_dataSet_reversVacancies(self):
        self.assertEqual(DataSet('vacancies.csv',["Дата публикации","15.12.2022"],"Думайте","","ядерка").reversVacancies,'' )
    def test_dataSet_formatter(self):
        self.assertEqual(DataSet('vacancies.csv',["Дата публикации","15.12.2022"],"Думайте","","ядерка").formatter({"name":"monkey","description":"<p>asdaisfuiasd</p>","key_skills":"banana","experience_id":"noExperience","premium":"Да","employer_name":"zoo","area_name":"Moscow","published_at":"2022-05-31T17:32:31+0300"}).elements,['monkey', 'asdaisfuiasd', 'banana', 'Нет опыта', 'Да', 'zoo', '', 'Moscow', datetime(2022, 5, 31, 17, 32, 31, 30000)])
